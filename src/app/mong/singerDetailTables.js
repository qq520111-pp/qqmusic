...
let singerDetailSchema = new Schema(
    {
        ...
        singer_mid: { type: String, required: true },
        singer_id: { type: Number, required: true },
        singer_img: { type: String, required: true },
        singerDesc: { type: String, required: true },
        songTotalNumber: { type: Number, required: true },
        fansTotalNumber: { type: Number, required: true },
        songList: [{
...
module.exports = { singerDetailTable }